    ...
    <div onClick={onClose} >
      <List>
        ...
        <ListItem component={Link} to='/GitHubProfileTracker/repositories'>
          ...
          <ListItemText primary="Repositories" sx={{ color: "text.primary" }} />
        </ListItem>
        <ListItem component={Link} to='/GitHubProfileTracker/followers'>
          <ListItemIcon>
            <SupervisorAccountRoundedIcon />
          </ListItemIcon>
          <ListItemText primary="Followers" sx={{ color: "text.primary" }} />
        </ListItem>
        <ListItem component={Link} to='/GitHubProfileTracker/following'>
          <ListItemIcon>
            <SwitchAccountRoundedIcon />
          </ListItemIcon>
          <ListItemText primary="Following" sx={{ color: "text.primary" }} />
        </ListItem>
      </List>
